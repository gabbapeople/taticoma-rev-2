...
void ReportDescParserBase::PrintUsagePage(uint16_t page) {
    ...
    output_if_between(page, 0x00, 0x11, w, E_Notify, usagePageTitles0, 0x80) else output_if_between(page, 0x8b, 0x92, w, E_Notify, usagePageTitles1, 0x80) else if (VALUE_BETWEEN(page, 0x7f, 0x84))
