...
"""autogenerated by genpy from taticoma_msgs/GetLegIKSolverRequest.msg. Do not edit."""
import sys
...
class GetLegIKSolverRequest(genpy.Message):
  ...
  _type = "taticoma_msgs/GetLegIKSolverRequest"
...
"""
  ...
  _slot_types = ['int32[]','taticoma_msgs/LegJointsState[]','taticoma_msgs/LegPositionState[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.target_position = []
      for i in range(0, length):
        val1 = taticoma_msgs.msg.LegPositionState()
        _x = val1
        start = end
        end += 24
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from taticoma_msgs/GetLegIKSolverResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetLegIKSolverResponse(genpy.Message):
  ...
  _type = "taticoma_msgs/GetLegIKSolverResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """taticoma_msgs/LegJointsState[] target_joints
int32 error_codes
...
"""
  ...
  _slot_types = ['taticoma_msgs/LegJointsState[]','int32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.target_joints:
        buff.write(_get_struct_3d().pack(*val1.joint))
      buff.write(_get_struct_i().pack(self.error_codes))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.error_codes,) = _get_struct_i().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class GetLegIKSolver(object):
  _type          = 'taticoma_msgs/GetLegIKSolver'
