...
"""autogenerated by genpy from taticoma_msgs/TeleopSerial.msg. Do not edit."""
import sys
...
class TeleopSerial(genpy.Message):
  _md5sum = "a826112f65f9a91607209418c91cb6b7"
  _type = "taticoma_msgs/TeleopSerial"
...
"""
  ...
  _slot_types = ['uint8[4]','uint8[2]','uint8[2]','uint8[2]','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TeleopSerial, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.axes is None:
        self.axes = b'\0'*4
      if self.a_buttons is None:
        self.a_buttons = b'\0'*2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.axes = str[start:end]
      start = end
      end += 2
      self.a_buttons = str[start:end]
      start = end
      end += 2
