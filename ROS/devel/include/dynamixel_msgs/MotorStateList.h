...
namespace message_traits {
    ...
    // {'dynamixel_msgs': ['/home/ubuntu/taticoma-rev-2/ROS/src/dynamixel_msgs/msg'], 'std_msgs': ['/opt/ros/melodic/share/std_msgs/cmake/../msg']}
...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_msgs::MotorStateList_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_msgs::MotorStateList_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::dynamixel_msgs::MotorStateList_<ContainerAllocator>& v) {
