...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_msgs::JointState_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_msgs::JointState_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::dynamixel_msgs::JointState_<ContainerAllocator>& v) {
            s << indent << "header: ";
            s << std::endl;
