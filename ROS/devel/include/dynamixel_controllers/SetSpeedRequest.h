...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_controllers::SetSpeedRequest_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_controllers::SetSpeedRequest_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::dynamixel_controllers::SetSpeedRequest_<ContainerAllocator>& v) {
            s << indent << "speed: ";
