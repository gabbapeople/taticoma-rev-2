...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_controllers::RestartControllerResponse_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_controllers::RestartControllerResponse_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::dynamixel_controllers::RestartControllerResponse_<ContainerAllocator>& v) {
            s << indent << "success: ";
