...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_controllers::SetComplianceSlopeResponse_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_controllers::SetComplianceSlopeResponse_<ContainerAllocator>> {
        ...
        static void stream(Stream&, const std::string&, const ::dynamixel_controllers::SetComplianceSlopeResponse_<ContainerAllocator>&) {}
    };
