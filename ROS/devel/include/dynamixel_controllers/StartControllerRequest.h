...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::dynamixel_controllers::StartControllerRequest_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::dynamixel_controllers::StartControllerRequest_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::dynamixel_controllers::StartControllerRequest_<ContainerAllocator>& v) {
            s << indent << "port_name: ";
