...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::taticoma_msgs::GaitCommand_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::taticoma_msgs::GaitCommand_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::taticoma_msgs::GaitCommand_<ContainerAllocator>& v) {
            s << indent << "cmd: ";
