...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::taticoma_msgs::TeleopCommand_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::taticoma_msgs::TeleopCommand_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::taticoma_msgs::TeleopCommand_<ContainerAllocator>& v) {
