...
namespace serialization {
    ...
    template <class ContainerAllocator>
    struct Serializer<::taticoma_msgs::LegPositionState_<ContainerAllocator>> {
...
namespace message_operations {
    ...
    struct Printer<::taticoma_msgs::LegPositionState_<ContainerAllocator>> {
        ...
        static void stream(Stream& s, const std::string& indent, const ::taticoma_msgs::LegPositionState_<ContainerAllocator>& v) {
            s << indent << "x: ";
