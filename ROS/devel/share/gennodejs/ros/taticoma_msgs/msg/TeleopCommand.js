...
class TeleopCommand {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.float32(obj.axes, buffer, bufferOffset, 4);
    ...
    bufferOffset = _arraySerializer.float32(obj.a_buttons, buffer, bufferOffset, 2);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TeleopCommand(null);
    // Deserialize message field [axes]
    data.axes = _arrayDeserializer.float32(buffer, bufferOffset, 4)
    // Deserialize message field [a_buttons]
    data.a_buttons = _arrayDeserializer.float32(buffer, bufferOffset, 2)
  ...
  static Resolve(msg) {
    ...
    const resolved = new TeleopCommand(null);
