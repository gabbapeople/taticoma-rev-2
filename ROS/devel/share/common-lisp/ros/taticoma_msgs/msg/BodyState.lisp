...
(cl:defmethod cl:initialize-instance :after ((m <BodyState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BodyState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-msg:<BodyState> is deprecated: use taticoma_msgs-msg:BodyState instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <BodyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:x-val is deprecated.  Use taticoma_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <BodyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:y-val is deprecated.  Use taticoma_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <BodyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:z-val is deprecated.  Use taticoma_msgs-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <BodyState>))
...
(cl:defmethod pitch-val ((m <BodyState>))
...
(cl:defmethod yaw-val ((m <BodyState>))
...
(cl:ensure-generic-function 'leg_radius-val :lambda-list '(m))
(cl:defmethod leg_radius-val ((m <BodyState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:leg_radius-val is deprecated.  Use taticoma_msgs-msg:leg_radius instead.")
  (leg_radius m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <BodyState>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'yaw))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'leg_radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BodyState>) istream)
  "Deserializes a message object of type '<BodyState>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'leg_radius) (roslisp-utils:decode-double-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BodyState>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64 leg_radius~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BodyState)))
  "Returns full string definition for message of type 'BodyState"
  (cl:format cl:nil "float64 x~%float64 y~%float64 z~%float64 roll~%float64 pitch~%float64 yaw~%float64 leg_radius~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <BodyState>))
  ...
  (cl:list 'BodyState
    ...
    (cl:cons ':yaw (yaw msg))
    (cl:cons ':leg_radius (leg_radius msg))
))
