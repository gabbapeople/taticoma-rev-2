...
(cl:defmethod cl:initialize-instance :after ((m <LegJointsState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LegJointsState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-msg:<LegJointsState> is deprecated: use taticoma_msgs-msg:LegJointsState instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <LegJointsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:joint-val is deprecated.  Use taticoma_msgs-msg:joint instead.")
  (joint m))
