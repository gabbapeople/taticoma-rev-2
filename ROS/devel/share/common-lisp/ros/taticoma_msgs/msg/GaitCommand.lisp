...
(cl:defmethod cl:initialize-instance :after ((m <GaitCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GaitCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-msg:<GaitCommand> is deprecated: use taticoma_msgs-msg:GaitCommand instead.")))
...
(cl:defmethod fi-val ((m <GaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:fi-val is deprecated.  Use taticoma_msgs-msg:fi instead.")
  (fi m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <GaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:velocity-val is deprecated.  Use taticoma_msgs-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'alpha-val :lambda-list '(m))
(cl:defmethod alpha-val ((m <GaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:alpha-val is deprecated.  Use taticoma_msgs-msg:alpha instead.")
  (alpha m))

(cl:ensure-generic-function 'scale-val :lambda-list '(m))
(cl:defmethod scale-val ((m <GaitCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:scale-val is deprecated.  Use taticoma_msgs-msg:scale instead.")
  (scale m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GaitCommand>)))
  ...
  (cl:format cl:nil "int32 cmd~%float64 fi~%float64 velocity~%float64 alpha~%float64 scale~%~%int32 RUNRIPPLE=1~%int32 RUNTRIPOD=2~%int32 STOP=3~%int32 PAUSE=4~%int32 SLEEP=5~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GaitCommand)))
  "Returns full string definition for message of type 'GaitCommand"
  (cl:format cl:nil "int32 cmd~%float64 fi~%float64 velocity~%float64 alpha~%float64 scale~%~%int32 RUNRIPPLE=1~%int32 RUNTRIPOD=2~%int32 STOP=3~%int32 PAUSE=4~%int32 SLEEP=5~%~%~%"))
