...
(cl:defclass <LegIKRequest> (roslisp-msg-protocol:ros-message)
  ((leg_number
   ...
   (current_joints
    ...
    :type taticoma_msgs-msg:LegJointsState
    :initform (cl:make-instance 'taticoma_msgs-msg:LegJointsState))
   (target_position
    :reader target_position
    :initarg :target_position
    :type taticoma_msgs-msg:LegPositionState
    :initform (cl:make-instance 'taticoma_msgs-msg:LegPositionState)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LegIKRequest>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LegIKRequest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-msg:<LegIKRequest> is deprecated: use taticoma_msgs-msg:LegIKRequest instead.")))

(cl:ensure-generic-function 'leg_number-val :lambda-list '(m))
(cl:defmethod leg_number-val ((m <LegIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:leg_number-val is deprecated.  Use taticoma_msgs-msg:leg_number instead.")
  (leg_number m))

(cl:ensure-generic-function 'current_joints-val :lambda-list '(m))
(cl:defmethod current_joints-val ((m <LegIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:current_joints-val is deprecated.  Use taticoma_msgs-msg:current_joints instead.")
  (current_joints m))

(cl:ensure-generic-function 'target_position-val :lambda-list '(m))
(cl:defmethod target_position-val ((m <LegIKRequest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-msg:target_position-val is deprecated.  Use taticoma_msgs-msg:target_position instead.")
  (target_position m))
