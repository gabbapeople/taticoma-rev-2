...
(cl:defmethod cl:initialize-instance :after ((m <BodyCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BodyCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-msg:<BodyCommand> is deprecated: use taticoma_msgs-msg:BodyCommand instead.")))
