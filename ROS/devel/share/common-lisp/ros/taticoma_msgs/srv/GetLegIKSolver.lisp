...
(cl:in-package taticoma_msgs-srv)
...
(cl:defclass <GetLegIKSolver-request> (roslisp-msg-protocol:ros-message)
  ((leg_number
   ...
   :initform (cl:make-array 0 :element-type 'taticoma_msgs-msg:LegJointsState :initial-element (cl:make-instance 'taticoma_msgs-msg:LegJointsState)))
   (target_position
    :reader target_position
    :initarg :target_position
    :type (cl:vector taticoma_msgs-msg:LegPositionState)
   :initform (cl:make-array 0 :element-type 'taticoma_msgs-msg:LegPositionState :initial-element (cl:make-instance 'taticoma_msgs-msg:LegPositionState))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetLegIKSolver-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLegIKSolver-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-srv:<GetLegIKSolver-request> is deprecated: use taticoma_msgs-srv:GetLegIKSolver-request instead.")))

(cl:ensure-generic-function 'leg_number-val :lambda-list '(m))
(cl:defmethod leg_number-val ((m <GetLegIKSolver-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-srv:leg_number-val is deprecated.  Use taticoma_msgs-srv:leg_number instead.")
  (leg_number m))

(cl:ensure-generic-function 'current_joints-val :lambda-list '(m))
(cl:defmethod current_joints-val ((m <GetLegIKSolver-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-srv:current_joints-val is deprecated.  Use taticoma_msgs-srv:current_joints instead.")
  (current_joints m))

(cl:ensure-generic-function 'target_position-val :lambda-list '(m))
(cl:defmethod target_position-val ((m <GetLegIKSolver-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-srv:target_position-val is deprecated.  Use taticoma_msgs-srv:target_position instead.")
  (target_position m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GetLegIKSolver-request>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'target_position)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'taticoma_msgs-msg:LegPositionState))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLegIKSolver-request>)))
  ...
  "taticoma_msgs/GetLegIKSolverRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLegIKSolver-request)))
  "Returns string type for a service object of type 'GetLegIKSolver-request"
  "taticoma_msgs/GetLegIKSolverRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLegIKSolver-request>)))
  ...
  (cl:format cl:nil "int32[] leg_number~%taticoma_msgs/LegJointsState[] current_joints~%taticoma_msgs/LegPositionState[] target_position~%~%~%================================================================================~%MSG: taticoma_msgs/LegJointsState~%float64[3] joint~%~%================================================================================~%MSG: taticoma_msgs/LegPositionState~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLegIKSolver-request)))
  "Returns full string definition for message of type 'GetLegIKSolver-request"
  (cl:format cl:nil "int32[] leg_number~%taticoma_msgs/LegJointsState[] current_joints~%taticoma_msgs/LegPositionState[] target_position~%~%~%================================================================================~%MSG: taticoma_msgs/LegJointsState~%float64[3] joint~%~%================================================================================~%MSG: taticoma_msgs/LegPositionState~%float64 x~%float64 y~%float64 z~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <GetLegIKSolver-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetLegIKSolver-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taticoma_msgs-srv:<GetLegIKSolver-response> is deprecated: use taticoma_msgs-srv:GetLegIKSolver-response instead.")))

(cl:ensure-generic-function 'target_joints-val :lambda-list '(m))
(cl:defmethod target_joints-val ((m <GetLegIKSolver-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-srv:target_joints-val is deprecated.  Use taticoma_msgs-srv:target_joints instead.")
  (target_joints m))

(cl:ensure-generic-function 'error_codes-val :lambda-list '(m))
(cl:defmethod error_codes-val ((m <GetLegIKSolver-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taticoma_msgs-srv:error_codes-val is deprecated.  Use taticoma_msgs-srv:error_codes instead.")
  (error_codes m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetLegIKSolver-response>)))
  ...
  "taticoma_msgs/GetLegIKSolverResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetLegIKSolver-response)))
  "Returns string type for a service object of type 'GetLegIKSolver-response"
  "taticoma_msgs/GetLegIKSolverResponse")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetLegIKSolver-response>)))
  ...
  (cl:format cl:nil "taticoma_msgs/LegJointsState[] target_joints~%int32 error_codes~%~%int32 IK_FOUND=1~%int32 IK_NOT_FOUND=-1~%int32 TIMED_OUT=-2~%~%~%================================================================================~%MSG: taticoma_msgs/LegJointsState~%float64[3] joint~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetLegIKSolver-response)))
  "Returns full string definition for message of type 'GetLegIKSolver-response"
  (cl:format cl:nil "taticoma_msgs/LegJointsState[] target_joints~%int32 error_codes~%~%int32 IK_FOUND=1~%int32 IK_NOT_FOUND=-1~%int32 TIMED_OUT=-2~%~%~%================================================================================~%MSG: taticoma_msgs/LegJointsState~%float64[3] joint~%~%~%"))
